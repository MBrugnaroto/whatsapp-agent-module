...
class VectorStore:
    ...
    def find_similar_memory(
        ...
        Args:
            ...
            thread_id: Optional thread/user ID to scope the search

        Returns:
            Optional Memory if a similar one is found
        """
        results = self.search_memories(text, k=1, thread_id=thread_id)
    ...
    def store_memory(self, text: str, metadata: dict) -> None:
        ...
        similar_memory = self.find_similar_memory(text, thread_id=metadata.get("thread_id"))
